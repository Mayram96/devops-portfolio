...
[![TP07 CI/CD](https://github.com/mayram96/devops-TP06/actions/workflows/cicd.yml/badge.svg)](https://github.com/mayram96/devops-TP06/actions)
...
| TP | Proyecto | Tecnologías | Link |
|---|---|---|---|
| 5 | API Python en Docker | Docker, Flask, Gunicorn | [→ ver repo](https://github.com/mayram96/devops-TP05) |
| 6 | App multi-contenedor | Docker Compose, Postgres, Nginx | [→ ver repo](https://github.com/mayram96/devops-TP06) |
| 7 | Pipeline CI/CD completo | GitHub Actions, pytest, Docker Hub | [→ ver repo](https://github.com/mayram96/devops-TP06) |
| 8 | Stack de monitoreo | Prometheus, Grafana, Node Exporter | [→ ver repo](https://github.com/mayram96/devops-TP08) |

### 9 al 12 — Kubernetes e IaC

| TP | Proyecto | Tecnologías | Link |
|---|---|---|---|
| 9 | App en Kubernetes | kubectl, Pods, Deployments, Services | [→ ver repo](https://github.com/mayram96/devops-TP09) |
| 10 | Helm Chart + Ingress | Helm, Ingress NGINX, HPA | [→ ver repo](https://github.com/mayram96/devops-TP10) |
| 11 | Infraestructura como Código | Terraform, módulos, state | [→ ver repo](https://github.com/mayram96/devops-TP11) |
| 12 | Portfolio final | GitHub Actions, integración | [→ este repo](https://github.com/mayram96/devops-portfolio) |
...
**Repo principal:** [devops-TP06](https://github.com/mayram96/devops-TP06)
